        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="flex flex-col sm:flex-row gap-2 sm:gap-[8px] items-start sm:items-center w-full">
            ...
            <button
              ...
              className="font-inter font-medium text-[14px] leading-[1.2] text-[#4d4d4d] underline hover:text-[#340A09] transition-colors disabled:opacity-50 disabled:cursor-not-allowed disabled:no-underline whitespace-nowrap"
