...
export let Registration = observer(() => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    console.log('🔵 handleSubmit начат');
    setLocalError("");
    setFirstNameError("");
    setLastNameError("");
    setEmailError("");
    ...
    if (!userData.email.includes('@')) {
      console.error('❌ Email не содержит @');
      setLocalError("Некорректный email адрес");
      return;
    }
  };
          ...
          <form className="flex flex-col gap-6 sm:gap-[30px]" onSubmit={handleSubmit} noValidate>
            ...
            <p className="font-inter font-normal text-[12px] leading-[1.2] text-[#888888] m-0">
              ...
              <Link 
                ...
                className="text-[#340A09] underline hover:text-[#370e0d] transition-colors"
                target="_blank"
              >
              ...
              <Link 
                ...
                className="text-[#340A09] underline hover:text-[#3b100f] transition-colors"
                target="_blank"
              >
            ...
            <button
              ...
              className="bg-[#340A09] h-[40px] min-h-[40px] px-[14px] py-0 rounded-[8px] hover:bg-[#340A09] transition-colors font-inter font-medium text-[16px] leading-[1.2] text-white disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:bg-[#9b1e1c]"
            >
