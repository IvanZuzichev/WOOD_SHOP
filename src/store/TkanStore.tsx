  ...
  _getStrapiImageUrl(imageData) {
    ...
    if (typeof imageData === 'string') {
      const url = imageData.startsWith('http') 
        ? imageData 
        : `https://cms.centertkani.ru${imageData}`;
    ...
    if (imageData.data) {
      ...
      if (attributes && attributes.url) {
        const url = `https://cms.centertkani.ru${attributes.url}`;
    ...
    if (imageData.attributes) {
      if (imageData.attributes.url) {
        const url = `https://cms.centertkani.ru${imageData.attributes.url}`;
    ...
    if (imageData.url) {
      const url = imageData.url.startsWith('http') 
        ? imageData.url 
        : `https://cms.centertkani.ru${imageData.url}`;
